...
class ThemeController extends FOSRestController
{
    ...
    */
     ...
     * @ApiDoc()
     * 
     * @Get("/theme/{id}", defaults={"id": null}, name="api_admin_get_theme", options={ "method_prefix" = false })
    */
     ...
     * @ApiDoc()
     * 
     * @Delete("/theme/{id}", name="api_admin_delete_theme", options={ "method_prefix" = false })
     */ 
     ...
     * @ApiDoc()
     * 
     * @Post("/theme", name="api_admin_post_theme", options={ "method_prefix" = false })
     */ 
