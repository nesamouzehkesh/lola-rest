...
class ProductAdminController extends FOSRestController
{
    /**
     * @ApiDoc()
     * 
     * @Get("/products", name="api_admin_product_get_products", options={ "method_prefix" = false })
    */
     ...
     * @ApiDoc()
     * 
     * @Get("/products/{id}", defaults={"id": null}, name="api_admin_product_get_product", options={ "method_prefix" = false })
    */
     ...
     * @ApiDoc()
     * 
     * @Delete("/products/{id}", name="api_admin_product_delete_product", options={ "method_prefix" = false })
     */ 
     ...
     * @ApiDoc()
     * 
     * @Post("/products", name="api_admin_product_post_product", options={ "method_prefix" = false })
     */ 
